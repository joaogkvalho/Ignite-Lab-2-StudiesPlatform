...
export function Subscribe(){
    ...
    return(
        <div className="min-h-screen bg-blur bg-cover bg-no-repeat flex flex-col items-center">
            ...
            <img src="/src/assets/image-mockup.png" className="mt-4" />

            <div className="w-full px-12 py-6 bg-gray-900 border-t border-gray-600 flex items-center justify-between">
